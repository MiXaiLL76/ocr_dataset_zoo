    ...
    $.widget("bw.sevenSeg", {
        ...
        */
        _create: function () {
            ...
            let l = this.options.thickness * 5;

            $("<defs/>")
                .append($("<polyline/>", {
                    id: "h-seg",
                    points: "11 " + (5 - l).toString() + ", 37 " + (5 - l).toString() + ", 42 5, 37 " + (5 + l).toString() + ", 11 " + (5 + l).toString() + ", 6 5"
                }))
                // 5-l, 11, 5,6, 5+l,11, 5+l,34, 5,39, 5-l,34
                .append($("<polyline/>", { id: "v-seg", points: "" + (5 - l).toString() + " 11, 5 6, " + (5 + l).toString() + " 11, " + (5 + l).toString() + " 34, 5 39, " + (5 - l).toString() + " 39" }))
                .appendTo(this.jqSvgElement);
            ...
            if (this.options.decimalPoint) {
                $("<circle/>", {
                    cx: this.options.decimalPointX.toString(),
                    cy: this.options.decimalPointY.toString(),
                    r: l.toString()
                }).appendTo(this.jqSvgElement);
            }
